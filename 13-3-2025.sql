...
--
-- Servidor: 127.0.0.2
-- Tiempo de generación: 13-03-2025 a las 14:26:34
...
--
-- Volcado de datos para la tabla `contenidos_libro`
--

INSERT INTO `contenidos_libro` (`id`, `libro_id`, `fecha`, `contenido`, `observaciones`, `fecha_creacion`, `fecha_modificacion`) VALUES
(1, NULL, '12/02/2025', 'Logaritmos', 'Ninguna', NULL, NULL);
...
--
-- Volcado de datos para la tabla `firmas_asistencia`
--

INSERT INTO `firmas_asistencia` (`id`, `profesor_id`, `curso_id`, `materia_id`, `fecha`, `hora_firma`) VALUES
(1, 26, 1, 1, '2025-03-11', '20:16:48'),
(2, 26, 1, 1, '2025-03-11', '20:20:06'),
(3, 26, 1, 1, '2025-03-11', '21:37:04');
...
--
-- AUTO_INCREMENT de la tabla `contenidos_libro`
--
ALTER TABLE `contenidos_libro`
