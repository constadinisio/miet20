...
public class BoletinesUtils {
    ...
    public static String construirRutaCompletaServidor(String apellido, String nombre,
            String curso, String division,
            String periodo) {
        try {
            ...
            String nombreCurso = curso + division;
            String rutaCarpeta;
            ...
            String nombreArchivo = String.format("Boletin_%s_%s_%s%s_%s_%s.xlsx",
                    apellidoLimpio, nombre.charAt(0), curso, division, periodo, fechaStr);

            return rutaCarpeta + nombreArchivo;

        } catch (Exception e) {
            System.err.println("Error construyendo ruta completa: " + e.getMessage());
            return null;
        }
    }
