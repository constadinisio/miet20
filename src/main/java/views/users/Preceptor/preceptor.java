 ...
 *
 * Funcionalidades principales: - Gestión de asistencias por curso - Selección
 * de curso y fecha - Navegación entre diferentes módulos
 *
...
public class preceptor extends javax.swing.JFrame {
     ...
     *
     * Inicializa componentes: - Verifica conexión a base de datos - Configura
     * imágenes - Carga componentes iniciales
     *
    ...
    public preceptor(int preceptorId) {
        ...
        new MenuBarManager(preceptorId, this);
    ...
    /**
     * Inicializa los componentes interactivos: - Selector de fecha - Combo de
     * cursos Configura listeners para cambios de selección
     */
    ...
    private void actualizarAsistencias() {
        ...
        main.java.utils.PanelUtils.addPanelWithOriginalLayout(panelPrincipal, panelAsistencia, BorderLayout.CENTER);
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/resources/images/icons8-user-96.png"))); // NOI18N
    ...
    private void botpreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botpreActionPerformed
        ...
        // Agregar el panel al panel principal según el tipo de layout
        if (panelPrincipal.getLayout() instanceof org.netbeans.lib.awtextra.AbsoluteLayout) {
            // Si es AbsoluteLayout, usar constrains
            panelPrincipal.add(panelSeleccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 71, 758, 50));
        } else if (panelPrincipal.getLayout() instanceof BorderLayout) {
            // Si es BorderLayout, especificar posición
            panelPrincipal.add(panelSeleccion, BorderLayout.NORTH);
        } else {
            // Para cualquier otro layout
