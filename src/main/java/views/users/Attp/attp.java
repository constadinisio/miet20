package main.java.views.users.Attp;

import main.java.views.users.Attp.menu.Registros;
import main.java.views.users.Attp.menu.Stock;
import java.sql.*;
import javax.swing.*;
 ...
 *
 * Características principales: - Gestión de netbooks - Conexión a base de datos
...
public class attp extends javax.swing.JFrame {
    ...
    // En la clase attp.java, añade esta variable de instancia
    private int attpId;
 ...
 */
     ...
     *
     * Construye un árbol jerárquico de: - Cursos - Materias por curso
     *
