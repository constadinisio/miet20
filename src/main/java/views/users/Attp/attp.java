...
public class attp extends javax.swing.JFrame {
    ...
    public attp() {
        ...
        initComponents();
        probar_conexion();
        rsscalelabel.RSScaleLabel.setScaleLabel(imagenLogo, "src/main/resources/images/logo_et20_max.png");
        rsscalelabel.RSScaleLabel.setScaleLabel(fondoHome, "src/main/resources/images/5c994f25d361a_1200.jpg");
